...
# Kernel
TARGET_PREBUILT_KERNEL := device/samsung/gts7xl/prebuilt/Image.gz
TARGET_PREBUILT_DTB := device/samsung/gts7xl/prebuilt/dtb
BOARD_PREBUILT_DTBOIMAGE := device/samsung/gts7xl/prebuilt/recoverydtbo
...
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/gts7xl/bootimg.mk
...
# Dynamic Partitions
BOARD_SUPER_PARTITION_SIZE := 10905190400
BOARD_SUPER_PARTITION_GROUPS := samsung_dynamic_partitions
BOARD_SAMSUNG_DYNAMIC_PARTITIONS_SIZE := 10900996096
...
TW_DEVICE_VERSION := 2_afaneh92-R
